...
<body>
	<form action="/MbassLayer/fbpost" method ="POST">
		<div class="text-input">
			<input type="text" name="facebookpost" value=""
				placeholder="         Update something in here!"> <label
				for="input1">Post Here</label> 
				
				<br/>
				<br/><input type="submit" value="FacebookPost">
		</div>
	</form>
</body>
</html>