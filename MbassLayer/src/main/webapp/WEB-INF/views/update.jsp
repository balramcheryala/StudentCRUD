...
<script>
	function validateForm() {
		...
		var z = document.forms["myForm"]["columnFieldValue"].value;
		if (z == null || z == "") {
			alert("columnFieldValue must be filled out");
			return false;
		}
	}
</script>
...
<body>
	...
	<div class="main-content">
		...
		<div class="widget" align="center" style="height: 525px">
			...
			<form name="myForm" action="updateRow"
				...
				<b style="color: #2D2D2D">Column_Field_Value</b>
				<p class="indent">
					<input type="text" class="foo" name="columnFieldValue"><br>
					<br>
