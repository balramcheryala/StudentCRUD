...
<script type="text/javascript">
	...
	<div class="main-content">
		<div class="title"><b style="color:#AC233E">REALTIME DATABASE</b></div>
		<div class="w3-container">
			<ul class="w3-navbar">
				<li><a href="insert"><b style="color:#186B4A">Insert JSON Key & Value Format</b></a></li>
				<li><a href="fileUploadForm"><b style="color:#186B4A">Upload JSON Table Schema</b></a></li>
		...
		<h2>
		<b style="color: #CF483F">Provide Database Table Information..!</b>
	</h2>
	<form name="myForm" action="remove" onsubmit="return validateForm()"
		method="post">
		<b style="color:#2D2D2D">Table_Name</b>
		<p class="indent">
			<input type="text" class="foo" name="tableName">
		</p>
		<b style="color: #2D2D2D">Column_Field_Name</b>
		<p class="indent">
			<input type="text" class="foo" name="columnFieldName">
		</p>
		<b style="color: #2D2D2D">Row_Id_Value</b>
		<p class="indent">
			<input type="text" class="foo" name="rowId"><br>
